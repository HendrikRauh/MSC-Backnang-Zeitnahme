    ...
    function createDOMPurify() {
        ...
        const _parseConfig = function _parseConfig() {
            ...
            if (cfg.TRUSTED_TYPES_POLICY) {
                ...
                if (
                    typeof cfg.TRUSTED_TYPES_POLICY.createScriptURL !==
                    "function"
                ) {
                    throw typeErrorCreate(
         ...
         */
        const _executeHook = function _executeHook(
            entryPoint,
            currentNode,
            data
        ) {
        ...
        const _sanitizeAttributes = function _sanitizeAttributes(currentNode) {
            ...
            while (l--) {
                ...
                let value =
                    name === "value" ? attrValue : stringTrim(attrValue);
