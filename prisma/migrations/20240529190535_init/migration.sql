/*
  ...
  - You are about to drop the column `penaltySec` on the `Time` table. All the data in the column will be lost.
...
INSERT INTO "new_Time" ("driverId", "endTimeId", "id", "notes", "startTimeId", "vehicleId") SELECT "driverId", "endTimeId", "id", "notes", "startTimeId", "vehicleId" FROM "Time";
DROP TABLE "Time";
